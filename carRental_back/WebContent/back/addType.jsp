...
<body>
	<div class=" clearfix">
		<div id="add_brand" class="clearfix">
			<div class="title_name" style="top: 0px;">添加类型</div>
			<form action="<%=request.getContextPath() %>/addCarTypeServlet" method="post"  enctype="multipart/form-data">
					<!-- 防止表单的重复提交 -->
					<% 
					...
					<!-- 防止表单的重复提交 -->
				<ul class="add_conent">
					<li class=" clearfix"><label class="label_name">类型名称：</label>
						<input style="width: 200px; height: 40px" name="typename" type="text"
						class="add_text" placeholder="请输入类型名称"/></li>
					<li class=" clearfix"><label class="label_name">添加日期：</label>
						<input name="date" type="date" style="width: 200px; height: 40px"></li>
					<li class=" clearfix"><label class="label_name">类型描述：</label>
						<textarea placeholder="请简单介绍此汽车类型..." style="width: 600px; height: 100px" name="introduce" cols=""
							rows="" class="textarea" onkeyup="checkLength(this);"></textarea>
					</li>
					<li class=" clearfix"><label class="label_name">类型图片：</label>
						<div class="demo l_f">
							<div class="logobox">
