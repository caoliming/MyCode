...
<form id="lg-form" action="${pageContext.request.contextPath }/user/login" onsubmit="return checkAll()" method="post" >
		...
		<div class="biaodan" >
			...
			<br>
			<div>
				<input value="zhangsan" type="text" name="u_name" id="username" placeholder="请输入用户名"/>
			</div>
			 <span id="Tusername" style="font-weight: 900 ;color:red;">.</span>
			<div>
				<input value="123456" type="password" name="u_psw" id="password" placeholder="请输入密码" />
			</div>
			...
			<div>
				...
				<img title="换一张" style="position:relative;top:10px ; width: 95px;height: 32px;border: 1px solid blue;border-radius:10px;" id="img"
			...
			<div>
				...
				&nbsp;&nbsp;&nbsp;&nbsp;
				<button type="button" id="register" onclick="reg()" style="color:#000000;font-family:楷体;">&nbsp;注&nbsp;册&nbsp;</button>
			</div>
		</div>
</form>
