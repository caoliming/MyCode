				...
				'<div class="ta_calendar_footer cf" '+ (this.mOpts.autoSubmit ? ' style="display:none" ' : '') +'>',
					'<div class="frm_msg">',
						'<div id="' + this.dateRangeDiv + '">',
							'<input type="text" style="width:100px;" class="ta_ipt_text_s" name="' + this.startDateId + '" id="' + this.startDateId + '" value="' + this.mOpts.startDate + '" readonly />',
							'<span class="' + this.mOpts.joinLineId + '"> - </span>',
...
pickerDateRange.prototype.close = function(btnSubmit) {
	...
	if(btnSubmit){
		...
		bDateTime = this.str2date($('#' + this.startDateId).val()).getTime();
		eDateTime = this.str2date($('#' + this.endDateId).val()).getTime();
