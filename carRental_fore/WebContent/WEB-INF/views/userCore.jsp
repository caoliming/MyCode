                            ...
                            <form method="post" action="" name="form1" style="width:500px;">
                                <table cellspacing="0" class="shop_table cart" style="width:500px;">
                                    ...
                                    <!-- 个人详情*********************************************************** -->
                                        ...
                                        <tr class="cart_item">
                                            <td class="product-thumbnail">年龄</td>
                                        	<td class="product-thumbnail">${user.age}</td>
                                        	<td class="product-thumbnail">住址</td>
                                        	<td class="product-thumbnail">${user.u_address}</td>
                                        </tr>
                                        <tr class="cart_item">
                                            <td class="product-thumbnail">积分</td>
                                            <td class="product-thumbnail">${user.userPb.p_pd}</td>
                                            <td class="product-thumbnail">注册日期</td>
                                            <td class="product-thumbnail">${user.u_date}</td>
                                        	
                                        </tr>
                                        <tr class="cart_item">
                                        	<td class="product-thumbnail">密码</td>
                                            <td class="product-thumbnail">${user.u_psw}</td>
                                           	<td class="product-thumbnail">
                                        		<input style="width: 130px;" type="text" id="nPs" placeholder="请输入新密码">
											</td>
                                        	<td class="product-thumbnail">
                                        ...
                                        <tr class="cart_item">
                                           	<td> <input style="border-radius:10px;background-color: #ccc;height: 42px;width: 75px;padding: 0;text-align: center;" type="button" onclick="getMonFun()" value="充值">
                                        	</td>
                                        	<td class="product-thumbnail">
                                        		<div style="border: none;font-size: 1.5em;color: red;">￥${user.userPb.p_money}</div>
                                           	</td>
                                            <td colspan="2" class="product-thumbnail">
                                           		 <input style="border-radius:10px;background-color: #ccc;height: 42px;width: 100px;padding: 0;text-align: center;" type="button" onclick="upPb()" value="兑换积分">
                                            </td>
                                        </tr>
                                    <!-- 购物车*********************************************************** -->
...
<script>
	...
	function upFun(){
		var newPs = document.getElementById("nPs").value;
		if(newPs==null || newPs==""){
			alert("请输入新密码!");
			return;
		}else{
