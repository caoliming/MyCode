								...
								<table cellspacing="0" class="shop_table cart" id="table1">
                                    ...
                                    <c:forEach var="o" items="${orders}">
                                    	<tr class="cart_item">
	                                        ...
	                                        <td class="product-thumbnail">
	                                        	<a class="xq" onclick="funXq('${o.o_code }')" href="javascript:;" style="text-decoration:none;border-radius:5px; border:1px solid #99CCFF;background-color:#99CC99; font-family:楷体;font-size:1.3em;color:#9933FF;font-weight: 900;">详情</a>
	                                        	...
	                                        	<a href="#" onclick="payOrder('${o.o_state }','${o.o_code }')" style="text-decoration:none;border-radius:5px; border:1px solid #99CCFF;background-color:#FFFFCC; font-family:楷体;font-size:1.3em;color:#9933FF;font-weight: 900;">付款</a>
	                                        </td>
                                   	    </tr>
                                    </c:forEach>
                                </table>
