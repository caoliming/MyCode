			...
			<div class="row">
				<div class="col-sm-6">
					<div class="logo">
						<h1>
							<a href="#"><img
								style="height: 140px;width: 170px;position: absolute;top: 0px;left:930px;"
								src="<%=request.getContextPath()%>/fore/img/logo.jpg"></a>
						</h1>
					</div>
				</div>
			</div>
									...
									<div role="tabpanel" class="tab-pane fade in active" id="home">
										<div style="margin-left: 100px;">
											<form action="<%=request.getContextPath() %>/paymentServlet">
												<label>订单号：</label>
												<input name="orderId" readonly="readonly" style="border: none;font-size: 1.4em;width: 400px;" value="${orderInfo.o_code}">
												
												<label style="margin-left: 40px;">应支付：</label>
												<input name="amount" readonly="readonly" style="border: none;font-size: 1.5em;color: red;" value="${orderInfo.allMoney}">
												<br>
												<br>
