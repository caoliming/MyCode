    ...
    <div class="single-product-area">
        <div class="zigzag-bottom"></div>
       	 ...
       	 <div style="margin-left:100px;margin-right:100px ;height:50px; width:1000;font-size: 1.4em;font-weight: 900;">
       	 		<p><label>>所有分类</label><a id="kz" style="margin-left: 800px;" onclick="funMenu()">收起分类</a> </p>
       	 </div>
       	 <div id="menu">
	       	<form style="margin-left:100px;margin-right:100px ;width:1000;" action="#">
	       		<p>
		       		...
		       		<label>汽车类型：</label>
		       		<select name="t_type" id="t_type" style="width: 192;height: 42px;border-color: #CCCCCC;">
		       		...
		       		<label>汽车品牌：</label> 
		       		<select name="b_name" id="b_name" style="width: 192;height: 42px;border-color: #CCCCCC;">
		       			<option value="">请选择...</option>
                ...
                <p>
                	...
                	<input type="button" onclick="queryTj()" value="条件查询" style="margin-left:345px; width: 192px;height: 42px;border-radius:10px; ">
                </p>
	       	</form>
	       	</div>
       	 </div>
...
function queryCarInfo(b_code) {
	window.location.href='${pageContext.request.contextPath }/car/getCarInfo/'+b_code;
            ...
            <!-- 遍历没有租出的汽车 -->
			<div style="margin-left:100px;margin-right:100px ;width:1000;height:600px;border:1px solid #CCCCCC;">
				<c:choose>
			...
			<div class="fenye" style="margin-left:100px;margin-right:100px ;width:1000;height:70px;border:1px solid #CCCCCC;">
				<ul>
					...
					<li>${pageDate.page}/${pageDate.totalPage}</li>
