...
public class User {
	...
	public User(int id, String u_name, String u_psw, String u_sex, int age, String u_card, String u_address,
			String u_phone, String u_img, String u_jscard, String u_date, UserPb userPb, UserRecode userRecode) {
		super();
		this.id = id;
		this.u_name = u_name;
		this.u_psw = u_psw;
	...
	public String toString() {
		return "User [id=" + id + ", u_name=" + u_name + ", u_psw=" + u_psw + ", u_sex=" + u_sex + ", age=" + u_age
				...
				+ ", u_jscard=" + u_jscard + ", u_date=" + u_date + ", userPb=" + userPb + ", userRecode=" + userRecode
				+ "]";
	}
